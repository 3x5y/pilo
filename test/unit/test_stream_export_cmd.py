...
from pilo.storage.snapshot import SnapshotName, SnapshotKind
import pilotest
...
class TestStreamExportCmd(pilotest.TestCase):
    ...
    def test_no_args_exits(self):
        mod = pilotest.import_command("storage-stream-export")
    ...
    @patch("pilo.storage.streams.export_incremental_stream")
    @patch("sys.argv", [
        "pilo-stream-export",
